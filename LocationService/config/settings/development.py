...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "apps.location.authentication.GatewayHeaderAuthentication",
    ),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Handles Location, Area, City and Country CRUD",
    "VERSION": "1.0.0",
...
SECRET_KEY = 'django-insecure-agg@s*jewp+v09%lip5ju&&#3jm!#tz2n)88v-#rt$#+!d&et%'
