...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "apps.reviews.authentication.GatewayHeaderAuthentication",
    ),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Handles Review CRUD",
    "VERSION": "1.0.0",
...
SECRET_KEY = 'django-insecure-4n#0l+o(47^l^5ljll6w4+smuz%tvbdgsd*8npqfopni1em7xj'
