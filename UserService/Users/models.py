...
class User(AbstractUser):
    ...
    location_zip_code = models.IntegerField(null=True, blank=True)
    ...
    daily_earning = models.IntegerField(null = True, blank = True)
    weekly_earning = models.IntegerField(null = True, blank = True)
    total_earning = models.IntegerField(null=True, blank= True)
    jobs_done = models.IntegerField(null = True, blank = True)
