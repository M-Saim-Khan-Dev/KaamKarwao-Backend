"""
Django settings for EarningService project.
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "apps.earning.authentication.GatewayHeaderAuthentication",
    ),
...
CELERY_BEAT_SCHEDULE = {
    'reset-daily-earnings': {
        'task': 'apps.earning.tasks.reset_daily_earnings',
        'schedule': crontab(hour=0, minute=0),
    },
    'reset-weekly-earnings': {
        'task': 'apps.earning.tasks.reset_weekly_earnings',
...
SECRET_KEY = 'django-insecure-)d9thw(6-(8c7b&zp1u!9j-#hb^_%r50b!)(9rlfu5=9v9qe%y'
